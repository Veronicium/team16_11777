...
class UniterEncoder(nn.Module):
    ...
    def forward(self, input_, attention_mask,
                output_all_encoded_layers=True, return_attn=False):
        all_encoder_layers = []
        hidden_states = input_
        for layer_module in self.layer:
            hidden_states, attn = layer_module(hidden_states, attention_mask, return_attn=True)
...
class UniterModel(UniterPreTrainedModel):
    ...
    def forward(self, input_ids, position_ids,
                ...
                txt_type_ids=None, img_type_ids=None, return_attn=False):
        ...
        out = self.encoder(
            ...
            output_all_encoded_layers=output_all_encoded_layers, return_attn=return_attn)
        if return_attn:
            encoded_layers, attn = out 
        else:
            encoded_layers = out
